...
object SelfAssessmentTaxReturnData {
  ...
  implicit val format: Format[SelfAssessmentTaxReturnData] =
      ...
      override def reads(json: JsValue): JsResult[SelfAssessmentResponseReturn] =
        for {
          ...
          incomeFromInterestNDividendsFromUKCompaniesNTrusts <-
            (json \ "incomeFromInterestNDividendsFromUKCompaniesNTrusts")
              .validate[Double]
...
object TaxYear {
  ...
  private def isValid(taxYearReference: String) =
